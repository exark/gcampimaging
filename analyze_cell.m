function [analysis_stack] = analyze_cell(contrast_level, p, f, varargin)
% when called with var args:
% analyze_cell(contrast, path, filename, basepoints)
...
if exist('basepoints')
    analysis_stack = dlr_analyse_visStim(basepoints, ...
                        file_path{1}, ...
                        file_path{2}, ...
                        file_path{3}, ...
                        file_path{4}, ...
